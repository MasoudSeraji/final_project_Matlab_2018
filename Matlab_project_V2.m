...
for VisualPathway_type=1:3
 VEP_N(:,:,VisualPathway_type)=extract_VEP(EEG_data_preprocessed_N,event_samples(VisualPathway_type,:));
end
...
for VisualPathway_type=1:3
 VEP_P(:,:,VisualPathway_type)=extract_VEP(EEG_data_preprocessed_P,event_samples(VisualPathway_type,:));
end
